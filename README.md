...
Flash is an official Gala appearance theme with high-contrast amber and ink, bold magazine type,
sharp geometry, and hard offset shadows. It changes presentation only: Gala's managed templates,
...
1. Publish this repository as `rathnasgala/theme-flash`.
...
4. Enter repository `theme-flash`, enter the exact SHA, and select **Verify release**.
5. Authors can then select **Flash** in their publication's Appearance settings when its framework
